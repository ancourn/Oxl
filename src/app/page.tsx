          ...
          <Tabs value={activeTab} className="w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <Badge variant={selectedTeam?.subscription.plan === "pro" ? "default" : "secondary"}>
                      {selectedTeam?.subscription.plan || "free"}
                    </Badge>
                  </CardHeader>
                  <CardContent>
                    <div className="text-sm text-muted-foreground">
                      {selectedTeam?.subscription.status === "active" ? "Active" : "Inactive"}
                    </div>
                  </CardContent>
                </Card>
              </div>
            ...
            <TabsContent value="docs">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">Docs interface will be implemented here.</p>
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="drive">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">Drive interface will be implemented here.</p>
                </CardContent>
              </Card>
            </TabsContent>
          </Tabs>
