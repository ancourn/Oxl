    ...
    return (
      <div className="h-screen flex flex-col bg-black">
        ...
        <div className="flex-1 flex">
          {/* Video grid */}
          <div className={`flex-1 grid grid-cols-2 gap-4 p-4 ${showChat ? 'pr-80' : ''}`}>
            {/* Local video */}
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-2">
                {messages.map((message) => (
                  <div key={message.id} className="text-sm">
                    <span className="font-medium text-blue-400">{message.user.name}: </span>
        ...
        {/* Meeting controls */}
        <div className="bg-gray-900 text-white p-4 flex items-center justify-center space-x-4">
          <Button
    ...
    <div className="container mx-auto py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-muted-foreground">Video meetings and screen sharing</p>
        </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between text-sm text-muted-foreground">
                    <span>Host: {room.host.name || room.host.email}</span>
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        navigator.clipboard.writeText(`${window.location.origin}/meet?roomId=${room.roomId}`);
